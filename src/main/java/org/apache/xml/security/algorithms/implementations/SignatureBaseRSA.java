...
public abstract class SignatureBaseRSA extends SignatureAlgorithmSpi {
	...
	Provider providerThread = JCEMapper.getProviderSignatureThread();
	...
	try {
		if (providerThread == null) {
			...
			this._signatureAlgorithm = Signature.getInstance(algorithmID,providerThread);
		}
