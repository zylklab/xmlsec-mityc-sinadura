 ...
 * 
 * Changes:
 *  * Constant to indicate digest algorithm
 * @author David Santos
 */
public class Constants {
   ...
   /** Property name that Private data ResourceResolverSpi must understand */
   public static final String PROPERTY_RR_ALG_DIGEST	 = "digest.algorithm";
