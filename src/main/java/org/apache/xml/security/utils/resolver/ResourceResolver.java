 ...
 * 
 * Changes:
 *  * allow to indicate a ResourceResolver that cannot access directly data (only digests). Usefull with private data.
 * @author David Santos
 */
public class ResourceResolver {
   ...
   /**
    * Mehotd canAccessData
    * 
    * @return
    */
   public boolean canAccessData() {
	   return !this._resolverSpi.engineIsPrivateData();
   }
}
